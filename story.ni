...
Warren Main Corridor North is a room. “The main artery of Deck 7 — a wide corridor by Warren standards, maybe three meters across. The ceiling is a tangle of exposed pipe and conduit. Foot traffic moves in both directions: shift workers heading to the lifts, scavengers hauling salvage carts, the occasional enforcer in scratched body armor. The corridor continues south, and the cube rows branch off to the north.”
Warren Main Corridor North is south of the Cube Row Junction.
...
Warren Main Corridor South is a room. “The corridor widens slightly here as it approaches the market district. Stall-fronts have been welded into the walls on both sides — metal shutters, hand-painted signs, the glow of neon strips. Most are closed at cycle-start, but a few early risers have their shutters up. The corridor continues south to the market square, and a narrow side passage leads east to the clinic.”
Warren Main Corridor South is south of Warren Main Corridor North.
...
The Clinic Passage is a room. “A narrow side corridor, quieter than the main drag. Fluorescent strips buzz overhead, half of them dead. The clinic entrance is to the east, marked by a faded red cross painted on the wall. A bench has been welded to the opposite wall.”
The Clinic Passage is east of Warren Main Corridor South.
...
The Clinic is a room. “A single room carved out of what was probably a storage bay. Harsh white light from overhead panels. A gurney, a cabinet of supplies, and a diagnostic terminal make up the entirety of the equipment. The walls are covered in laminated hygiene notices that nobody reads.”
The Clinic is east of the Clinic Passage.
...
Warren Market Square is a room. “The heart of Deck 7 — a roughly circular open space where four corridors converge. The ceiling is higher here, maybe five meters, and the space has been colonized by market stalls, food vendors, and at least one establishment with blacked-out windows and a bouncer. The air is thick with cooking smoke, the buzz of haggling, and the bass thrum of music from somewhere below the deck plates. Exits lead north, east, south, and west.”
Warren Market Square is south of Warren Main Corridor South.
...
Warren East Corridor is a room. “The corridor heading east from the market. The foot traffic picks up here — this is the route to the transtube station. Directional arrows painted on the walls in faded yellow point the way. The overhead lighting is slightly better maintained, probably because the transit authority actually pays for upkeep on the approaches.”
Warren East Corridor is east of Warren Market Square.
...
Transtube Approach is a room. “The corridor opens up into a wider concourse as you approach the transtube station. The walls transition from raw metal to actual panels — scratched and graffitied, but panels nonetheless. Overhead signage in station-standard amber reads: DECK 7 — TRANSTUBE ACCESS. A security checkpoint blocks the way east, staffed by a bored-looking transit officer behind a scarred plexiglass booth.”
...
Warren South Corridor is a room. “The corridor south from the market leads toward the deck's outer ring. It's quieter here — residential territory, such as it is. Doorways line both sides, most covered with improvised curtains or welded-on privacy screens. The overhead lighting dims to a brownish flicker. The corridor ends at a viewing gallery to the south.”
Warren South Corridor is south of Warren Market Square.
...
The Transpex Tube is east of the Ring Transtube Station.
...
Ring Mid Central is a room. Ring Mid Central is zero-grav. “The central junction of the Docking Ring's mid-level — a cavernous open space where three travel lanes converge. The Ring stretches away in every direction: west and east along the main axis, up and down between levels. The scale is dizzying — the Ring's interior is a hollow cylinder two hundred meters across, crisscrossed with guide cables, cargo tethers, and blinking nav-buoys. Ships are visible in their slips along the outer wall, dark shapes bristling with antennae and hull plating.[paragraph break]A navigation buoy floats nearby, anchored to a guide cable. The grav-lock hatch is to the south.”
Ring Mid Central is north of the Ring Grav-Lock.
...
Ring Upper Central is a room. Ring Upper Central is zero-grav. “The upper-central junction of the Ring. The ceiling — such as it is — curves close here, the inner surface of the Ring's hull studded with access panels and maintenance hatches. The travel lanes branch west, east, and down. Above, a second grav-lock leads up to the shuttle berth bay. A large nav-buoy spins slowly at the junction, its amber light sweeping the space.”
...
Ring Mid West is a room. Ring Mid West is zero-grav. “The mid-level western junction. The outer wall of the Ring is close here — you can see the massive doors of docking slip 1B directly to the west, and the dark shapes of ships berthed in the adjacent slips. The guide cables here are thicker, heavy-duty lines meant for towing loaded cargo pods.”
Ring Mid West is west of Ring Mid Central.
...
Ring Lower West is a room. Ring Lower West is zero-grav. “The lower-western junction, deep in the Ring's industrial belly. Slip 1C's doors are to the west. The air — such as it is in zero-grav — carries the chemical tang of hull sealant and thruster propellant. Maintenance drones buzz past on pre-programmed routes.”
...
Ring Mid East is a room. Ring Mid East is zero-grav. “The mid-level eastern junction. Slip 3B's docking doors are visible to the east. This section of the Ring sees heavy traffic — it's closest to the commercial berths, and traders, couriers, and customs inspectors drift through constantly. A customs drone hovers at the junction, scanning passing cargo with a blue laser grid.”
Ring Mid East is east of Ring Mid Central.
...
Ring Upper East is a room. Ring Upper East is zero-grav. “The upper-eastern corner of the Ring. Slip 3A's berth doors are to the east. Through a gap in the structure, you can see the hull of a docked freighter — enormous, pitted with micrometeorite scars, its running lights blinking a slow amber pulse.”
...
Ring Lower East is a room. Ring Lower East is zero-grav. “The lower-eastern junction. Slip 3C is to the east. This is the quietest corner of the Ring — the slips down here tend to house long-term berths, ships in for repairs or mothballed by owners who stopped paying fees. A few have been here so long they've grown a patina of micro-corrosion.”
...
Docking Slip 2A is a room. Docking Slip 2A is zero-grav. “An upper-central berth, currently vacant. This is a premium slip — close to the shuttle berths and the main transit connections. The docking equipment here is newer, better maintained. A berth status panel shows AVAILABLE — PREMIUM RATE.”
Docking Slip 2A is north of Ring Upper Central.
...
Docking Slip 2C is north of Ring Lower Central.
...
Docking Slip 3A is a room. Docking Slip 3A is zero-grav. “An upper-east berth. A bulk freighter fills the slip, so large that it barely fits — the hull nearly touches the docking clamps on both sides. The ship's name, PROVIDENCE, is painted in letters three meters tall.”
Docking Slip 3A is east of Ring Upper East.
...
Docking Slip 3B is a room. Docking Slip 3B is zero-grav. “A mid-level east berth. Two small ships share this slip, docked side by side — a prospector rig and a salvage tug, both showing hard use. Their crews have strung a cargo net between them, creating an improvised communal space where figures in coveralls share food and talk.”
Docking Slip 3B is east of Ring Mid East.
...
Docking Slip 3C is a room. Docking Slip 3C is zero-grav. “The lower-east berth — the quietest slip in the Ring. The ship here has been docked so long that micro-corrosion has begun to spread across its hull in fractal patterns of rust and verdigris. No lights. No crew. No name. Just a dead ship slowly becoming part of the station.”
Docking Slip 3C is east of Ring Lower East.
...
The Shuttle Berth Bay is a room. The Shuttle Berth Bay is normal-grav. “Gravity reasserts itself as you pass through the grav-lock — this bay has its own spin section, a small drum rotating to provide a comfortable pull. The shuttle berth bay is a long, vaulted hangar with berths on both sides, each one a recessed alcove with a shuttle parked nose-in. A central walkway runs the length of the bay, lined with departure gates and ticket kiosks. Overhead, a destination board lists shuttle routes to dozens of locations too far or too awkward for the transtube network. The grav-lock hatch is set into the floor at the south end.”
The Shuttle Berth Bay is above the Shuttle Grav-Lock.
