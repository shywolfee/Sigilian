...
Part 20 - Xyrokk Streets and Districts

Chapter 1 - Main Path Rooms

The Perimeter Road is a room. The Perimeter Road is north of the Xyrokk Landing Field. The description of the Perimeter Road is "A wide unpaved road circling the outer edge of the city, rutted by ground vehicles and caravans. Dust hangs in the air like a permanent atmosphere — kicked up by wheels, by hooves, by the downdraft of low-flying cargo skiffs. To the south, the landing field shimmers in the heat. To the north, the city wall rises: ancient black sandstone at the base, modern composite and sensor arrays bolted on top, the whole structure leaning slightly inward as though the city is trying to close itself off from the desert it was built in."

The perimeter-caravans are scenery in the Perimeter Road. The description of the perimeter-caravans is "Desert caravans — long trains of hover-sleds and stubborn pack animals bred for Xyrokk's punishing heat. They haul ore, salvage, and trade goods from the deep desert settlements, queuing at the gate with the patience of people who have been making this journey for generations. The drivers wear sand-colored wraps and darkened goggles, their skin the color of the clay beneath them." The printed name of the perimeter-caravans is "caravans". Understand "caravans" or "caravan" or "vehicles" or "sleds" as the perimeter-caravans.

The city-wall is scenery in the Perimeter Road. The description of the city-wall is "The outer wall of Xyrokk. The lower courses are the same black sandstone as the gate pylons — quarried and fitted five thousand years ago, still standing, still plumb. Above the ancient stone, centuries of addition: fired brick, reinforced concrete, durasteel plating, sensor arrays, automated defense turrets that probably haven't been maintained in decades. The wall is not one wall but twenty walls, each era building its own on top of the last." The printed name of the city-wall is "city wall". Understand "wall" or "city wall" or "walls" or "fortification" as the city-wall.

The Gate Plaza is a room. The Gate Plaza is north of the Gate of Ashes. The description of the Gate Plaza is "A wide, roughly circular plaza just inside the gate, worn smooth by millennia of foot traffic. This is where the city begins in earnest — the open space acts as a decompression chamber between the desert and the density ahead. Money changers work from stone booths older than their entire family lines. Guides call out in accented Common, offering to navigate the labyrinth for a fee. Off-duty soldiers lounge against the ancient pylons, watching the crowd with the minimal interest of people who have seen it all before.[paragraph break]The Ashway stretches north, the city's main artery. Side streets branch east and west into the first layer of districts."

The plaza-changers are scenery in the Gate Plaza. The description of the plaza-changers is "Money changers in stone booths, converting Imperial credits to local barter tokens and back again. Xyrokk's economy runs on three parallel systems — Imperial credit, local token, and straight barter — and the changers navigate all three with the ease of people whose families have been doing this since before the Empire existed. Their booths are carved from the same black sandstone as the city foundations. The changers will outlast the currency." The printed name of the plaza-changers is "money changers". Understand "changers" or "money changers" or "booths" or "money" as the plaza-changers.

The plaza-guides are scenery in the Gate Plaza. The description of the plaza-guides is "Freelance guides, mostly young, shouting offers in three languages. They know the city the way water knows a drainage system — every shortcut, every dead end, every street that used to go somewhere before a building collapsed on it. Some of them are honest. The rest are honest enough for Xyrokk." The printed name of the plaza-guides is "guides". Understand "guides" or "guide" as the plaza-guides.

The Ashway South is a room. The Ashway South is north of the Gate Plaza. The description of the Ashway South is "The southern stretch of the Ashway, where the boulevard is at its widest and newest. Off-world businesses cluster here — shipping offices, translation services, a franchise food stall selling vacuum-packed station meals to homesick travelers. The buildings are newer than further north, only a few centuries old, their facades a mix of local sandstone and imported polymer. Holographic signs flicker in the dry air, advertising in scripts you can read and scripts you cannot.[paragraph break]The boulevard continues north toward the city center. Side streets lead east and west into quieter districts."

The ashway-south-shops are scenery in the Ashway South. The description of the ashway-south-shops is "Off-world businesses catering to new arrivals: shipping agents, currency exchanges, translators, equipment rental. The storefronts are modern polymer and glass, grafted onto sandstone walls like prosthetics. They look temporary — not because they are badly built, but because Xyrokk makes everything look temporary. The city has swallowed a thousand businesses like these and will swallow a thousand more." The printed name of the ashway-south-shops is "shops". Understand "shops" or "businesses" or "offices" or "storefronts" as the ashway-south-shops.

The ashway-south-signs are scenery in the Ashway South. The description of the ashway-south-signs is "Holographic advertisements shimmer in the heat-distorted air, selling off-world passage, desert tours, imported goods. Half of them are in Imperial Common. The rest are in older scripts — angular, geometric, carved into the stone beneath the holograms. The old signs are not advertisements. No one alive can read them." The printed name of the ashway-south-signs is "signs". Understand "signs" or "holograms" or "advertisements" or "holographic" as the ashway-south-signs.

The Ashway Intersection is a room. The Ashway Intersection is north of the Ashway South. The description of the Ashway Intersection is "A major crossing where the Ashway meets two wide cross-streets, the traffic flowing around a central island dominated by an ancient obelisk of black sandstone. The obelisk is ten meters tall, its surface covered in the same geometric carvings as the gate pylons, still humming faintly after five millennia. Modern traffic — hover-carts, pedestrians, the occasional ground vehicle — flows around it without acknowledgment, the way a river flows around a boulder it has long since given up trying to move.[paragraph break]The Ashway continues north. A street of metalworkers leads west."

The intersection-obelisk is scenery in the Ashway Intersection. The description of the intersection-obelisk is "Black sandstone, ten meters of it, carved with geometric patterns that interlock and tesselate from base to tip in a single unbroken design. The obelisk hums — the same sub-audible vibration as the carvings in the Sunken Quarter, but fainter, worn down by exposure to wind and sand and five thousand years of the white sun's radiation. Someone has bolted a modern traffic beacon to its base. The obelisk does not appear to mind." The printed name of the intersection-obelisk is "obelisk". Understand "obelisk" or "pillar" or "monument" or "beacon" as the intersection-obelisk.

The intersection-traffic are scenery in the Ashway Intersection. The description of the intersection-traffic is "The intersection is the busiest point on the Ashway — hover-carts loaded with goods, pedestrians in desert wraps and off-world clothing, the occasional Imperial patrol moving through with the purposeful indifference of an occupying force that knows it is merely the latest in a long line." The printed name of the intersection-traffic is "traffic". Understand "traffic" or "crowd" or "pedestrians" or "hover-carts" as the intersection-traffic.

The Carved Passage is a room. The Carved Passage is east of the Ashway. The description of the Carved Passage is "A narrow street descending eastward where the modern layers of the city peel away like dead skin. With each step down, the polymer facades give way to bare sandstone, then to the darker, older stone beneath. The walls close in. The carvings appear — geometric patterns at first, then something more complex, interlocking designs that seem to shift at the edge of vision. The air cools. The light dims. The sound of the Ashway fades behind you, replaced by a low, almost inaudible hum rising from the stone itself."

The passage-walls are scenery in the Carved Passage. The description of the passage-walls is "The walls of the passage are the city's cross-section made visible — layers of construction stripped back to reveal the dark stone beneath. The carvings on that stone are older than anything on the surface, cut with a precision that modern tools would struggle to match. They are not decorative. They are functional, though the function has been forgotten by everyone except the stone." The printed name of the passage-walls is "walls". Understand "walls" or "carvings" or "stone" or "patterns" as the passage-walls.

The Upper Sunken Street is a room. The Upper Sunken Street is east of the Carved Passage. The description of the Upper Sunken Street is "A transitional street where the surface city and the buried city overlap. Buildings stand half-submerged in compacted sand — their upper floors at street level, their lower floors swallowed by the slow orange tide of the desert. Doorways that were once at ground level are now skylights. Windows that once looked out onto the street now stare into packed sand. The effect is disorienting, as though the city is sinking and you are standing still.[paragraph break]The street continues east into the Sunken Quarter proper. The Carved Passage leads back west toward the Ashway."

The half-buried-buildings are scenery in the Upper Sunken Street. The description of the half-buried-buildings is "Buildings caught mid-submersion, their architecture visible in cross-section like a geological sample. The upper floors are lived in — laundry hangs from windows, light glows behind shutters. The buried floors are dark, sealed, given over to the sand. The residents treat the arrangement as normal. On Xyrokk, it is." The printed name of the half-buried-buildings is "buildings". Understand "buildings" or "houses" or "upper floors" or "windows" as the half-buried-buildings.

The Sunken Alley is a room. The Sunken Alley is north of the Sunken Quarter. The description of the Sunken Alley is "Deeper into the buried old city. The alley narrows until you can touch both walls with outstretched arms, the ancient stone pressing close, its surface dense with geometric carvings that have never seen direct sunlight. The hum is stronger here — not just felt but almost heard, a sustained chord rising from somewhere beneath the sand-packed floor. Light comes from bioluminescent strips bolted to the walls by someone practical enough to illuminate what the original builders never intended to be dark."

The alley-carvings are scenery in the Sunken Alley. The description of the alley-carvings is "The carvings here are sharper than those on the surface — protected from wind and sun, they retain every line, every angle. The geometric patterns are more complex than the ones above, layered, three-dimensional, cut into the stone at varying depths to create designs that seem to move when the bioluminescent light shifts. You have the persistent sense that you are reading something you cannot understand." The printed name of the alley-carvings is "carvings". Understand "carvings" or "patterns" or "geometric" or "designs" as the alley-carvings.

The alley-lights are scenery in the Sunken Alley. The description of the alley-lights is "Bioluminescent strips — cheap, widely available, the kind you can buy at any station market. Someone has bolted them to five-thousand-year-old stone with modern adhesive and plastic brackets. The juxtaposition should be jarring. Instead it feels inevitable — the new clinging to the old, the way everything on Xyrokk clings to what came before." The printed name of the alley-lights is "lights". Understand "lights" or "strips" or "bioluminescent" or "illumination" as the alley-lights.

The Buried Intersection is a room. The Buried Intersection is north of the Sunken Alley. The description of the Buried Intersection is "A convergence of buried streets beneath a ceiling of packed sand and stone — the underside of a building foundation that was itself built on top of these older streets millennia ago. Several passages meet here, their mouths dark and carved, leading into sections of the old city that may or may not still be passable. The hum of the carvings resonates in the enclosed space, layered harmonics bouncing off the low ceiling. A sand-filled chamber opens to the east. The passage north grows louder."

The buried-ceiling are scenery in the Buried Intersection. The description of the buried-ceiling is "The ceiling is the underside of a foundation — massive stone blocks fitted together without mortar, their surfaces rough and uncarved, purely structural. Above them, you know, there are more buildings, more streets, more layers of the city climbing toward the white sun. Below you, there may be more layers still. Xyrokk goes down as far as it goes up, and no one has found the bottom." The printed name of the buried-ceiling is "ceiling". Understand "ceiling" or "foundation" or "blocks" as the buried-ceiling.

The Resonance Approach is a room. The Resonance Approach is north of the Buried Intersection. The description of the Resonance Approach is "A straight corridor of ancient stone leading north, its walls, floor, and ceiling covered in geometric carvings that grow denser and more complex with each step. The hum is no longer sub-audible — it is a sound, a deep sustained chord that vibrates in your chest and blurs your vision at the edges. The carvings pulse with faint amber light, the same light you saw in the transit arch descriptions, growing brighter as you approach whatever lies ahead. The air tastes of mineral dust and ozone and deep time."

The approach-carvings are scenery in the Resonance Approach. The description of the approach-carvings is "The carvings here have crossed a threshold from pattern into something else — a language, a circuit, a score. They cover every surface in interlocking designs that pulse with amber light, each pulse synchronized with the deep hum that fills the corridor. You are walking through a machine made of stone, still running after five thousand years, still doing whatever it was built to do." The printed name of the approach-carvings is "carvings". Understand "carvings" or "patterns" or "light" or "amber" as the approach-carvings.

Chapter 2 - Branch Rooms

The Dust Market is a room. The Dust Market is east of the Gate Plaza. The description of the Dust Market is "An open-air market sprawling across a sand-floored square just inside the city walls, shaded by a patchwork canopy of polymer tarps, woven fabric, and repurposed cargo netting. The stalls sell desert goods — dried meats, sand-resistant tools, salvaged tech pulled from ruins in the deep desert. The air smells of spice and machine oil and the particular mineral scent of Xyrokk's orange sand. Haggling is conducted in three languages simultaneously, none of them quietly."

The market-stalls are scenery in the Dust Market. The description of the market-stalls is "Rows of stalls built from salvage and sandstone scraps, their wares spread on blankets and folding tables. Desert salvage dominates — corroded hull plating, crystalline formations pulled from deep sand deposits, ancient carved stones whose geometric patterns still hum faintly. The sellers know what everything is worth, or claim to, or have decided to, which on Xyrokk amounts to the same thing." The printed name of the market-stalls is "stalls". Understand "stalls" or "market" or "wares" or "goods" as the market-stalls.

The market-canopy are scenery in the Dust Market. The description of the market-canopy is "A patchwork ceiling of tarps, fabric, and cargo netting strung between buildings and poles, filtering the white sunlight into something almost bearable. The canopy has been repaired and extended so many times that no original section remains — it is a ship of Theseus made of shade, and it does its job." The printed name of the market-canopy is "canopy". Understand "canopy" or "tarps" or "shade" or "netting" as the market-canopy.

The Caravan Rest is a room. The Caravan Rest is east of the Dust Market. The description of the Caravan Rest is "A wide, walled compound where desert caravans park their hover-sleds and stable their beasts between runs. The air is thick with animal musk and engine exhaust and the sharp smell of whatever fuel the hover-sleds burn. Traders sit in the shade of their vehicles, drinking something dark from ceramic cups, conducting business with the unhurried patience of people who measure time in desert crossings rather than hours."

The rest-beasts are scenery in the Caravan Rest. The description of the rest-beasts is "Xyrokk draft beasts — massive, six-legged, armored in natural chitin the same orange as the desert clay. They stand in pens of ancient stone, chewing cud with mechanical patience, utterly indifferent to the hover-sleds parked beside them. The beasts have been bred for this work for millennia. The hover-sleds are newer, but the beasts don't seem threatened. They have outlasted every other innovation." The printed name of the rest-beasts is "beasts". Understand "beasts" or "animals" or "creatures" or "pens" as the rest-beasts.

The rest-traders are scenery in the Caravan Rest. The description of the rest-traders is "Caravan traders resting between runs, their sand-colored wraps pushed back from weathered faces. They drink bitter kaf from ceramic cups and trade information as casually as cargo — which routes are passable, which ruins have been picked clean, which deep-desert settlements are buying and what they're paying. The real economy of Xyrokk runs on conversations like these." The printed name of the rest-traders is "traders". Understand "traders" or "drivers" or "cups" as the rest-traders.

Mechanic's Row is a room. Mechanic's Row is west of the Gate Plaza. The description of Mechanic's Row is "A street of ship repair shops carved into the base of the city wall, their workshops spilling out onto the road in a tangle of hull plating, cable bundles, and diagnostic equipment. Welding sparks cascade from open bay doors. The sound of metal on metal rings off the sandstone. Parts dealers hawk components from blankets on the ground — some new, some salvaged, some of uncertain provenance. If you need your ship fixed on Xyrokk, this is where you come. If you need it fixed well, you ask around first."

The mechanic-shops are scenery in Mechanic's Row. The description of the mechanic-shops is "Workshop bays carved directly into the ancient city wall, their interiors a jumble of modern equipment and improvised tools. Mechanics work on ships from a dozen worlds using techniques ranging from precision nanofabrication to hitting things with hammers. Both approaches seem equally effective. The smell of solder and lubricant and scorched polymer hangs in the still air like a permanent feature of the geography." The printed name of the mechanic-shops is "shops". Understand "shops" or "workshops" or "bays" or "mechanics" as the mechanic-shops.

The mechanic-parts are scenery in Mechanic's Row. The description of the mechanic-parts is "Components spread on blankets and stacked in crates — hull plating, drive coils, atmospheric processors, things you can identify and things you cannot. The parts dealers swear everything works. Some of it does." The printed name of the mechanic-parts is "parts". Understand "parts" or "components" or "equipment" or "plating" as the mechanic-parts.

Spice Lane is a room. Spice Lane is east of the Ashway South. The description of Spice Lane is "A narrow street where the air itself has flavor — layers of scent so dense they become almost visible, a haze of ground spice and dried herb and powdered mineral that coats your tongue and makes your eyes water. The shops are small, deep, carved from sandstone, their doorways hung with bundles of dried plants and racks of ceramic jars. Apothecaries and spice sellers have occupied this street for so long that the stone walls have absorbed the scent permanently. Even if every shop closed tomorrow, Spice Lane would still smell like this in a thousand years."

The spice-shops are scenery in Spice Lane. The description of the spice-shops is "Narrow shops carved deep into the sandstone, their shelves lined with ceramic jars of every size. The contents range from culinary spices to medicinal compounds to substances whose purpose the sellers describe with careful vagueness. Some jars hum faintly — the same resonance as the ancient carvings, as though the contents respond to the city's deep vibration." The printed name of the spice-shops is "shops". Understand "shops" or "jars" or "apothecaries" or "spices" as the spice-shops.

The spice-air are scenery in Spice Lane. The description of the spice-air is "The air is thick with particulate spice — cinnamon-adjacent, pepper-adjacent, and things adjacent to nothing you have ever encountered. You can taste minerals in it, desert dust, something faintly electric. Breathing in Spice Lane is a full sensory experience whether you want it to be or not." The printed name of the spice-air is "spice-scented air". Understand "air" or "scent" or "smell" or "haze" as the spice-air.

Water Seller's Court is a room. Water Seller's Court is west of the Ashway South. The description of Water Seller's Court is "A small courtyard centered on an ancient stone cistern, its rim worn smooth by five thousand years of hands reaching for water. On Xyrokk, water is wealth — more reliable than credits, more stable than barter tokens, older than any currency. The sellers measure it in precise ceramic cups, pricing by purity and source. Desert-distilled commands a premium. Recycled station water is cheapest. The courtyard is quiet despite the trade — water business is conducted in low voices, as befits a sacred transaction."

The court-cistern is scenery in Water Seller's Court. The description of the court-cistern is "A stone cistern older than the surrounding buildings, its rim carved with geometric patterns long since worn to ghosts by generations of reaching hands. The water inside is dark and still. It comes from somewhere beneath the city — a deep aquifer, a buried river, a source that has sustained Xyrokk since before the first stone was laid. The sellers guard the cistern with the quiet intensity of people protecting something irreplaceable." The printed name of the court-cistern is "cistern". Understand "cistern" or "water" or "well" as the court-cistern.

The water-sellers are scenery in Water Seller's Court. The description of the water-sellers is "Men and women with measured movements and careful eyes, dispensing water in ceramic cups of graduated sizes. They know the value of what they sell the way a jeweler knows gems — by weight, by clarity, by provenance. They do not haggle. The price is the price. On a desert planet, the water seller sets the terms." The printed name of the water-sellers is "sellers". Understand "sellers" or "vendors" or "cups" as the water-sellers.

Foundry Street is a room. Foundry Street is west of the Ashway Intersection. The description of Foundry Street is "A street of metalworkers where the ancient and the modern fuse in every forge. Smiths work the same black sandstone anvils their predecessors used millennia ago, shaping alloys with plasma torches and traditional hammers in the same stroke. The heat radiating from the open forges adds another layer to Xyrokk's already punishing warmth. Sparks drift in the still air like slow orange stars. The ring of metal is constant — a percussion section for the city's deeper hum."

The foundry-forges are scenery in Foundry Street. The description of the foundry-forges is "Open forges built into sandstone alcoves, each one a hybrid of ancient and modern — traditional stone hearths fitted with plasma heating elements, bellows systems connected to powered air compressors. The smiths move between technologies without distinction, as though five thousand years of metallurgical progress is simply one long unbroken tradition. On Xyrokk, it is." The printed name of the foundry-forges is "forges". Understand "forges" or "forge" or "anvils" or "anvil" or "hearths" as the foundry-forges.

The foundry-sparks are scenery in Foundry Street. The description of the foundry-sparks is "Orange sparks drifting from the forges, hanging in the still, superheated air before dying. They match the color of the desert clay, the sand, the sunlight through the dust — everything on Xyrokk tends toward orange, as though the planet has a palette and insists on it." The printed name of the foundry-sparks is "sparks". Understand "sparks" or "embers" as the foundry-sparks.

The Ashway North is a room. The Ashway North is north of the Ashway. The description of the Ashway North is "The Ashway continues northward, but the character changes. The tourist-friendly stalls and off-world businesses thin out, replaced by local workshops, grub bars with no signs, doorways leading into unlit interiors. The boulevard narrows as buildings encroach from both sides — newer construction, slapdash, built for function over form. The black sandstone foundations are still visible at street level, but everything above is industrial: sheet metal, composite panels, exhaust vents trailing heat shimmer. The air tastes of smelter smoke and hot metal.[paragraph break]Side streets branch east and west. A stone path leads west. The boulevard continues north into the industrial quarter."

The ashway-north-workshops are scenery in the Ashway North. The description of the ashway-north-workshops is "Local workshops — metalwork, electronics repair, fabrication — their interiors visible through open doorways. The workers don't look up. They are focused on their tasks with the concentration of people who are paid by the piece and waste nothing, least of all attention on passersby." The printed name of the ashway-north-workshops is "workshops". Understand "workshops" or "shops" or "doorways" as the ashway-north-workshops.

The ashway-north-smoke are scenery in the Ashway North. The description of the ashway-north-smoke is "A haze of smelter smoke drifting south from the industrial quarter, thinning as it goes but never quite dissipating. It smells of hot metal and chemical processing and the particular acrid note of alloys being separated into component elements. The smoke has been drifting down this boulevard for centuries. The sandstone is stained with it." The printed name of the ashway-north-smoke is "smoke". Understand "smoke" or "haze" or "smog" or "fumes" as the ashway-north-smoke.

The Ash Quarter is a room. The Ash Quarter is north of the Ashway North. The description of the Ash Quarter is "The smelting district — the industrial heart that gives the Ashway its name. Refineries and smelters line the street, their chimneys pouring smoke into the bleached sky, the heat from their furnaces adding to the planet's natural hostility. The buildings here are purely functional: metal-walled, flat-roofed, vibrating with the bass rumble of heavy machinery. Workers move between the smelters in heat-resistant gear, faces hidden behind reflective visors. Even the ancient sandstone foundations look scorched here, darkened by centuries of radiant heat and chemical exposure."

The quarter-smelters are scenery in the Ash Quarter. The description of the quarter-smelters is "Industrial smelters processing ore hauled in from the deep desert — massive structures of heat-resistant alloy and refractory brick, their interiors glowing orange-white through observation slits. The ore goes in as raw rock. It comes out as refined metal ingots, stacked on hover-pallets and shipped to fabrication shops across the city. The smelters run continuously. They have run continuously for as long as anyone can remember." The printed name of the quarter-smelters is "smelters". Understand "smelters" or "refineries" or "furnaces" or "chimneys" as the quarter-smelters.

The quarter-workers are scenery in the Ash Quarter. The description of the quarter-workers is "Smelter workers in heat-resistant suits, their faces hidden behind reflective visors that turn them into anonymous figures moving through the industrial haze. The work is hard, hot, and essential — Xyrokk's metal trade is one of the few things the Empire values enough to leave mostly alone. The workers know this. It gives them a particular kind of leverage and a particular kind of pride." The printed name of the quarter-workers is "workers". Understand "workers" or "laborers" or "visors" as the quarter-workers.

Pilgrims' Walk is a room. Pilgrims' Walk is west of the Ashway North. The description of Pilgrims' Walk is "An ancient stone path, its paving slabs worn into shallow curves by millennia of feet. The path is older than the buildings around it — they have grown up on either side like canyon walls, but the path was here first, cutting through the rock before there was a city to cut through. The carved geometric patterns on the paving stones are faint but present, the same language of shape and vibration that runs through all of old Xyrokk. The path leads west toward a terrace overlooking the lower city."

The walk-stones are scenery in Pilgrims' Walk. The description of the walk-stones is "Paving slabs worn into gentle concavities by the passage of feet over millennia — a physical record of devotion, each stone a shallow bowl shaped by the cumulative weight of pilgrims walking toward something they believed in. The geometric carvings on their surfaces are almost erased, visible only when the light hits them at the right angle." The printed name of the walk-stones is "paving stones". Understand "stones" or "paving" or "slabs" or "path" as the walk-stones.

The Temple Terrace is a room. The Temple Terrace is west of Pilgrims' Walk. The description of the Temple Terrace is "A broad stone terrace jutting from the city's upper levels, offering a view that explains why someone built a temple here. The lower city spreads out below — a maze of rooftops and streets and smoke, stretching to the distant shimmer of the city wall and the orange desert beyond. The temple itself is a ruin: black sandstone columns, a partial roof, walls carved with geometric patterns that still hum with faint resonance. Whatever faith built this place has been forgotten. The stone remembers, even if no one else does."

The temple-ruins are scenery in the Temple Terrace. The description of the temple-ruins is "Columns of black sandstone, some standing, some fallen, supporting the remnants of a roof that once covered a space large enough for hundreds. The carvings on the columns are the oldest you have seen — deeper, more complex, their geometric patterns creating shapes that seem to fold inward on themselves. The hum here is different from elsewhere in the city: lower, slower, almost mournful, as though the stone is sustaining a note that no one is left to hear." The printed name of the temple-ruins is "ruins". Understand "ruins" or "temple" or "columns" or "roof" as the temple-ruins.

The temple-view are scenery in the Temple Terrace. The description of the temple-view is "The city below, seen from above — a labyrinth of rooftops at different heights, connected by bridges and ladders and walkways, the streets visible only as dark gaps between buildings. Smoke rises from the Ash Quarter to the east. The white sun turns everything flat and shadowless. In the far distance, the desert — the orange clay hardpan that was here before the city and will be here after, patient and absolute." The printed name of the temple-view is "view". Understand "view" or "panorama" or "city" or "rooftops" as the temple-view.

Smelter Approach is a room. Smelter Approach is east of the Ashway North. The description of Smelter Approach is "A wide road leading east toward the smelting yards, built for heavy traffic — the surface is reinforced composite laid over ancient stone, scored by the passage of loaded hover-pallets. The heat intensifies with each step as the smelter furnaces grow closer, their radiant warmth adding to the white sun's assault until the air itself seems to thicken. Noise fills the street: the bass rumble of machinery, the hiss of cooling systems, the clang of metal being shaped by force."

The approach-pallets are scenery in Smelter Approach. The description of the approach-pallets is "Hover-pallets loaded with raw ore heading toward the smelters, and empty ones heading back — a constant flow of materials along a route worn into the city's daily rhythm. The pallet drivers navigate by habit, barely looking, their routes as fixed as the ancient streets they travel." The printed name of the approach-pallets is "hover-pallets". Understand "pallets" or "hover-pallets" or "ore" or "carts" as the approach-pallets.

The Sand-Filled Chamber is a room. The Sand-Filled Chamber is east of the Buried Intersection. The description of the Sand-Filled Chamber is "A room the desert is reclaiming. Sand fills it to within a meter of the ceiling, leaving only a narrow crawl-space of breathable air above the orange dune that has spent centuries slowly consuming this chamber. The walls are visible above the sand line — carved, of course, the geometric patterns dense and intricate, their hum muted by the mass of sand pressing against them. This was a room once. A large one. Whatever purpose it served is buried now, along with whatever was inside it. The sand does not explain itself."
